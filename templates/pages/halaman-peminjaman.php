		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<ul>
					...
					<li>
						<div><i class="lnr lnr-users"></i></div><input type="text" name="jumlah_orang" placeholder="Jumlah Orang" required="required"/>
					</li>
					
					<li>
						<div><i class="lnr lnr-dinner"></i></div><select name="konsumsi" required="required">
							<option value="" selected>Pilih Konsumsi</option>
				...
				<ul>
					...
					<li>
						<div><i class="lnr lnr-layers"></i></div><select name="nama_ruangan" required="required">
							<option value="" selected>Ruang</option>
							<?php foreach($tb_ruangan as $baris_ruangan): ?>
								<?php if($baris_ruangan['status'] == 'Tersedia' || $baris['nama_ruangan'] == $baris_ruangan['nama_ruangan']): ?>
									<option value="<?php echo $baris_ruangan['nama_ruangan']; ?>" <?php if($baris['nama_ruangan'] == $baris_ruangan['nama_ruangan']) echo 'selected'; ?>>
										<?php echo $baris_ruangan['nama_ruangan']; ?>
									</option>
								<?php endif; ?>
							<?php endforeach; ?>
					...
					<li>
						<div><i class="lnr lnr-users"></i></div><input type="number" name="jumlah_orang" value="<?php echo $baris['jumlah_orang']; ?>" placeholder="Jumlah Orang" required="required" />
					</li>

					<li>
						<div><i class="lnr lnr-dinner"></i></div><select name="konsumsi" required="required">
							<option value="" selected>Pilih Konsumsi</option>
							<option value="makanan_berat" <?php if($baris['konsumsi'] == 'makanan_berat') echo 'selected'; ?>>Makanan Berat</option>
							<option value="makanan_ringan" <?php if($baris['konsumsi'] == 'makanan_ringan') echo 'selected'; ?>>Makanan Ringan</option>
						</select>
					</li>

					<li>
						<div><i class="lnr lnr-text-format"></i></div><input type="text" name="keterangan" value="<?php echo $baris['keterangan']; ?>" placeholder="Keterangan" required />
					</li>
